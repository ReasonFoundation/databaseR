...
#masterView() function has 2 parameters:
  #source = "TEXT" and expand = TRUE/FALSE
  #source allows to filter for a given datat source (e.g. "Reason", "Public Plans Database", "Census")
  #expand allow to trigger SQL function that either returns list of mapped variables (FALSE - default) or all available variables (TRUE)

    #library(devtools)
    #library(roxygen2)
    #masterView.test <- source_url("https://raw.githubusercontent.com/ReasonFoundation/databaseR/master/files/PensionDatabase.test.R")
